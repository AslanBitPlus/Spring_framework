...
import org.example.core.EmailSender;
import org.example.scope.Prototype;
import org.example.scope.Singleton;
import org.example.spring_demo.Application;
...
public class Homework {
  ...
  public static void main(String[] args) {
      ...
      System.out.println("Билет №1 => " + generator.createNewNumber());
//      System.out.println("Билет №2 => " + ticketDisplay.newTicket());
//      System.out.println("Билет №3 => " + ticketDisplay.newTicket());
